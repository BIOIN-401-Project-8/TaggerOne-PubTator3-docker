...
public class ScoreKeeper implements Serializable {
	...
	public Object2DoubleMap<String> getScores() {
		...
		scores.put(EvaluationProcessor.TP, tp);
		scores.put(EvaluationProcessor.FP, fp);
		scores.put(EvaluationProcessor.FN, fn);
		scores.put(EvaluationProcessor.P, getP());
		scores.put(EvaluationProcessor.R, getR());
		scores.put(EvaluationProcessor.F, getF());
		return scores;
	}
