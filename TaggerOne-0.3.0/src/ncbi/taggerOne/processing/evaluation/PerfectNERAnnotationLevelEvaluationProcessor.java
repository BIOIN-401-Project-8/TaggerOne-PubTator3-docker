...
public class PerfectNERAnnotationLevelEvaluationProcessor extends EvaluationProcessor {
	...
	@Override
	public PerfectNERAnnotationLevelEvaluationProcessor copy() {
		return new PerfectNERAnnotationLevelEvaluationProcessor(scoreDetailPrefix, normalizationPredictionModels);
	}
	...
	public Object2DoubleMap<String> getScores() {
		...
		for (String s : overallScores.keySet()) {
			String s2 = String.format("BOUNDARY+ID+PERFECT_NER\t%s\t%s", T1Constants.OVERALL_EVALUATION, s);
