...
public class PerfectNERInstanceLevelEvaluationProcessor extends EvaluationProcessor {
	...
	@Override
	public PerfectNERInstanceLevelEvaluationProcessor copy() {
		return new PerfectNERInstanceLevelEvaluationProcessor(scoreDetailPrefix, normalizationTrainingPredictionModels);
	}
	...
	public Object2DoubleMap<String> getScores() {
		...
		for (String s : overallScores.keySet()) {
			String s2 = String.format("INSTANCE+PERFECT_NER\t%s\t%s", T1Constants.OVERALL_EVALUATION, s);
