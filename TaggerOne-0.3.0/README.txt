...
A. [Versions]
	...
	0.2.2 Added memory profiling and significantly reduced memory usage
	      Added ability to use normalization lexicon for NER dictionary feature
...
G. [Instructions for training TaggerOne]
	...
	•	BC5CDR chemicals: ./Train_BC5CDRC.sh 10.0 1.5 output/model_BC5CDRC 2>&1 | tee train_BC5CDRC.log
